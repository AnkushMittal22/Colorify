...
const ColorChanger = () => {
  ...
  const addColorHandler = async (event) => {
    ...
    await axios
      .post(
        `https://colour-change-7c507-default-rtdb.firebaseio.com/colorss/${userid}.json`,
        {
          red: red,
          green: green,
          blue: blue,
  ...
  const editHandler = (id) => {
    ...
    axios
      .put(
        `https://colour-change-7c507-default-rtdb.firebaseio.com/colorss/${userid}/${id}.json`,
        editColor
      )
      .then((resolve) => {
        getDataToAxios();
  ...
  const removeHanlder = (id) => {
    ...
    axios
      .delete(
        `https://colour-change-7c507-default-rtdb.firebaseio.com/colorss/${deleteId}/${id}.json`
      )
      .then((resolve) => {
        console.log(resolve);
        getDataToAxios();
